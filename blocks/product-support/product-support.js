...
export default async function decorate(block) {
  ...
  const product = json.Product.data.find((product) => product.ProductCodes.split('|').some((code) => code === productCode) && product.Languages.split('|').some((productLanguage) => productLanguage.toUpperCase() ===  language.toUpperCase()));
